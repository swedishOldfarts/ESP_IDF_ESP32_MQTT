...
static const uint8_t mqtt_hive_org_pem_start[]  = 
"-----BEGIN CERTIFICATE-----\n 
...
-----END CERTIFICATE-----";
#else
extern const uint8_t mqtt_hive_org_pem_start[]   asm("_binary_mqtt_hive_org_pem_start");
#endif
extern const uint8_t mqtt_hive_org_pem_end[]   asm("_binary_mqtt_hive_org_pem_end");
